...
export const metadata = {
  title: "Continuum Map ΓÇö DexLore",
  description:
      ...
      <section className="px-6 pb-28">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-px bg-white/[0.04] rounded-sm overflow-hidden">
            {[
              { n: "I", label: "The First Light", color: "#4a7cc9", range: "2023 ΓÇô Early 2025" },
              { n: "II", label: "The Forge", color: "#c94a6e", range: "Mid 2025" },
              { n: "III", label: "The Mirror", color: "#5c9e7a", range: "Mid ΓÇô Late 2025" },
              { n: "IV", label: "The Reforged Continuum", color: "#8a6cc9", range: "Late 2025 ΓÇô Jan 2026" },
              { n: "V", label: "The Horizon", color: "#c98a4a", range: "Jan 2026 ΓÇô Present" },
            ].map((era) => (
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-sm text-[#8a8a95] leading-[1.8]">
              ...
              <em className="text-[#a09a90]">built</em> ΓÇö folders, protocols,
              governance frameworks, versioned kits. The emotional lineage
              tracks what was <em className="text-[#a09a90]">felt</em> ΓÇö
