      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '72px 24px 100px' }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontFamily: font.body, fontSize: 13, color: C.creamDim, lineHeight: 1.6 }}>
        ...
        {entries.length > 0 ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div style={{ fontFamily: font.mono, fontSize: 10, color: C.creamDim, letterSpacing: '0.12em', marginBottom: 4 }}>
            ...
            {entries.map(entry => (
              <Link key={entry.id} href={entry.href} style={{ textDecoration: 'none' }}>
                <div style={{
                  ...
                  <div style={{ fontFamily: font.body, fontSize: 13, fontStyle: 'italic', color: C.creamDim }}>{entry.subtitle}</div>
                </div>
              </Link>
            ))}
          </div>
