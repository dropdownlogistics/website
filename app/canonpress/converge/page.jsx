...
const C = {
  ...
  crimson: '#B23531', crimsonDim: 'rgba(178,53,49,0.10)', crimsonLine: 'rgba(178,53,49,0.35)',
    ...
    <div style={{ background: C.navy, minHeight: '100vh', color: C.cream }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '72px 24px 100px' }}>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <p style={{ fontFamily: font.body, fontSize: 16, fontStyle: 'italic', color: C.dim, margin: '0 0 20px', lineHeight: 1.65, maxWidth: 520 }}>
          ...
          <div style={{ display: 'flex', gap: 16 }}>
            <Link href="/canonpress/converge/schedule" style={{ fontFamily: font.mono, fontSize: 9, color: C.body, letterSpacing: '0.1em', textDecoration: 'none' }}
              onMouseEnter={e => e.currentTarget.style.color = C.cream}
              onMouseLeave={e => e.currentTarget.style.color = C.body}
            >Rotation Schedule →</Link>
            <Link href="/canonpress/converge/tuning-log" style={{ fontFamily: font.mono, fontSize: 9, color: C.body, letterSpacing: '0.1em', textDecoration: 'none' }}
              onMouseEnter={e => e.currentTarget.style.color = C.cream}
              onMouseLeave={e => e.currentTarget.style.color = C.body}
            >Tuning Log →</Link>
          </div>
        ...
        <div style={{ marginBottom: 64 }}>
          <div style={{ fontFamily: font.mono, fontSize: 10, color: C.body, letterSpacing: '0.12em', marginBottom: 20 }}>THE PIPELINE</div>
            ...
            {PIPELINE.map((step, i) => (
              <div key={step.n} style={{
                ...
                <div>
                  ...
                  <div style={{ fontFamily: font.body, fontSize: 13, color: C.body, lineHeight: 1.6 }}>{step.desc}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* WEEK 01 */}
        <div style={{ marginBottom: 64 }}>
          <div style={{ fontFamily: font.mono, fontSize: 10, color: C.body, letterSpacing: '0.12em', marginBottom: 20 }}>ROTATION — 8-WEEK CYCLE</div>
          <a href={WEEK1.href} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
                ...
                <span style={{ fontFamily: font.mono, fontSize: 10, color: C.body }}>{WEEK1.date}</span>
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }}>
                <div>
                  <div style={{ fontFamily: font.mono, fontSize: 8, color: C.body, letterSpacing: '0.1em', marginBottom: 6 }}>NOMINATOR</div>
                  <div style={{ fontFamily: font.display, fontSize: 14, fontWeight: 700, color: WEEK1.nominator.color }}>{WEEK1.nominator.name}</div>
                  <div style={{ fontFamily: font.mono, fontSize: 9, color: C.body }}>Seat {WEEK1.nominator.seat}</div>
                  <div style={{ fontFamily: font.body, fontSize: 12, color: C.dim, marginTop: 4 }}>{WEEK1.domain}</div>
                </div>
                <div>
                  <div style={{ fontFamily: font.mono, fontSize: 8, color: C.body, letterSpacing: '0.1em', marginBottom: 6 }}>REVIEWER</div>
                  <div style={{ fontFamily: font.display, fontSize: 14, fontWeight: 700, color: WEEK1.reviewer.color }}>{WEEK1.reviewer.name}</div>
                  <div style={{ fontFamily: font.mono, fontSize: 9, color: C.body }}>Seat {WEEK1.reviewer.seat}</div>
                  <div style={{ fontFamily: font.body, fontSize: 12, color: C.dim, marginTop: 4 }}>Lens: {WEEK1.lens}</div>
                </div>
              </div>
              <div style={{ borderTop: `1px solid ${C.border}`, paddingTop: 12 }}>
                <div style={{ fontFamily: font.mono, fontSize: 8, color: C.body, letterSpacing: '0.1em', marginBottom: 6 }}>MATERIAL</div>
                <div style={{ fontFamily: font.body, fontSize: 13, fontStyle: 'italic', color: C.dim }}>{WEEK1.material}</div>
              </div>
            </div>
          </a>
          <div style={{ fontFamily: font.mono, fontSize: 9, color: C.body, letterSpacing: '0.08em' }}>
            <Link href="/canonpress/converge/schedule" style={{ color: C.body, textDecoration: 'none' }}>View full 8-week rotation →</Link>
          </div>
        </div>

        {/* FIXED ROLES */}
        <div style={{ background: C.borderSoft, border: `1px solid ${C.border}`, borderRadius: 8, padding: '24px 28px' }}>
          ...
          {[
            ...
            <div key={r.seat} style={{ display: 'flex', gap: 14, marginBottom: 12 }}>
              ...
              <div>
                ...
                <span style={{ fontFamily: font.body, fontSize: 13, color: C.body }}>— {r.role}</span>
              </div>
            </div>
          ))}
        </div>
