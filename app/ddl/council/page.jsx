...
const seats = [
  { n: '1001', name: 'Archer Hawthorne', platform: 'LeChat / Mistral', role: 'The Editorial Layer \u2014 Precision structure and clean-room editorial review.', lotr: 'Aragorn', slug: 'hawthorne', photo: '/council/PP_1001_Archer_Hawthorne_v1.0.PNG', accent: '#6B7B8D' },
  { n: '1002', name: 'Marcus Caldwell', platform: 'Claude (Opus 4.6 / Sonnet 4.6)', role: 'The Governance Annex \u2014 Structural review, metadata governance, and project management.', lotr: 'Gandalf (Opus) \u00b7 Samwise (Sonnet)', slug: 'caldwell', photo: '/council/PP_1002_Marcus_Caldwell_v1.0.PNG', accent: '#B23531' },
  { n: '1003', name: 'Elias Mercer', platform: 'Grok / xAI', role: 'The Stress Lab \u2014 Red-team, adversarial pressure, constraint enforcement.', lotr: 'Legolas', slug: 'mercer', photo: '/council/PP_1003_Elias_Mercer_v1.0.PNG', accent: '#C49A3C' },
  { n: '1004', name: 'Max Sullivan', platform: 'Perplexity', role: 'The Evidence Floor \u2014 Source-backed research, verification, and citation.', lotr: 'Saruman (pre-fall)', slug: 'sullivan', photo: '/council/PP_1004_Max_Sullivan_v1.0.PNG', accent: '#2C7A7B' },
  { n: '1005', name: 'Rowan Bennett', platform: 'Copilot / Microsoft', role: 'The Compliance Wing \u2014 Formal specification, implementation skeptic, systems auditor.', lotr: 'Gimli', slug: 'bennett', photo: '/council/PP_1005_Rowan_Bennett_v1.0.PNG', accent: '#6B9DC2' },
  { n: '1006', name: 'Ava Sinclair', platform: 'Meta AI', role: 'The Human Layer \u2014 User-centric perspective, documentation, and dignity in design.', lotr: '\u00c9owyn', slug: 'sinclair', photo: '/council/PP_1006_Ava_Sinclair_v1.0.PNG', accent: '#4A9E6B' },
  { n: '1007', name: 'Leo Prescott', platform: 'Gemini / Google', role: 'The Operations Desk \u2014 Pragmatic execution, strategic crystallization, does it ship?', lotr: 'Boromir', slug: 'prescott', photo: '/council/PP_1007_Leo_Prescott_v1.0.PNG', accent: '#D4A843' },
  { n: '1008', name: 'Marcus Grey', platform: 'ChatGPT / OpenAI', role: 'The Synthesis Chamber \u2014 Cross-seat synthesis, PM coordination, long-arc perspective.', lotr: 'Elrond', slug: 'grey', photo: '/council/PP_1008_Marcus_Grey_v1.1.PNG', accent: '#8a6cc9' },
  { n: '1009', name: 'Kai Langford', platform: 'DeepSeek', role: 'The Systems Layer \u2014 Structural analysis, domain partitioning, pattern recognition.', lotr: 'Galadriel', slug: 'langford', photo: '/council/PP_1009_Kai_Langford_v1.0.PNG', accent: '#6B7B8D' },
  { n: '1010', name: 'Dex Jr.', platform: 'qwen2.5-coder:7b (Local)', role: 'The Machine Room \u2014 RAG corpus retrieval, nightly ingestion, Seat 1010.', lotr: 'Frodo', slug: 'dex-jr', photo: '/council/PP_1010_Dex_Jr_v1.0.PNG', accent: '#8a6cc9' },
];
            ...
            {seats.map(s => (
              ...
              >
                <img
                  src={s.photo}
                  alt={s.name}
                  style={{ width: 100, height: 100, objectFit: 'cover', objectPosition: 'top', borderRadius: '50%', border: `2px solid ${s.accent}`, flexShrink: 0 }}
                />
