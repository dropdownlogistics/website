...
export default function KnowledgeVaultBrandKit() {
  return (
    <div style={{ minHeight: '100vh', background: '#0D1B2A' }}>
      ...
      <iframe src="/brand/DDL-KnowledgeVault-BrandKit-v1.0.html" style={{ display: 'block', width: '100%', height: 'calc(100vh - 36px)', border: 'none' }} />
    </div>
  );
}
