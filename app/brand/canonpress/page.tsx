...
export default function CanonPressBrandKit() {
  return (
    <div style={{ minHeight: '100vh', background: '#0D1B2A' }}>
      ...
      <iframe src="/brand/CanonPress-BrandKit-v1_0.html" style={{ display: 'block', width: '100%', height: 'calc(100vh - 36px)', border: 'none' }} />
    </div>
  );
}
