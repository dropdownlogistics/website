    ...
    <div style={{ background: C.card, border: `1px solid ${color}25`, borderRadius: 8, marginBottom: 10, position: "relative", overflow: "hidden" }}>
      ...
      <div onClick={() => setOpen(!open)} style={{ padding: "16px 20px", cursor: "pointer", userSelect: "none" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 8, marginBottom: 8 }}>
          ...
          <span style={{ fontFamily: font.mono, fontSize: 14, color: C.creamDim, transform: open ? "rotate(90deg)" : "rotate(0deg)", transition: "transform 0.15s" }}>â-¸</span>
        </div>
    ...
    <div style={{ minHeight: "100vh", background: C.navy, color: C.cream, fontFamily: font.body }}>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 820, margin: "0 auto", padding: "48px 24px 64px" }}>
        <div style={{ fontFamily: font.mono, fontSize: 9, color: C.violet, letterSpacing: "0.25em", textTransform: "uppercase", marginBottom: 32 }}>
          DDL Â· CONSOLE Â· The Sonic Thread
        </div>
        ...
        <div style={{ fontFamily: font.mono, fontSize: 10, color: C.creamDim, marginBottom: 4 }}>
          Cross-reference: <span style={{ color: C.crimson }}>Catnip Map</span> Â· <span style={{ color: C.amber }}>Sensory Diet</span> Â· <span style={{ color: C.amber }}>Callback Engine</span> Â· <span style={{ color: C.violet }}>DOSSIER</span>
        </div>
        ...
        <div style={{ borderLeft: `3px solid ${C.violet}`, padding: "14px 20px", background: C.violetDim, borderRadius: "0 6px 6px 0", marginBottom: 32 }}>
          <p style={{ fontFamily: font.body, fontSize: 16, fontStyle: "italic", color: C.creamHigh, lineHeight: 1.6, margin: 0 }}>
            ...
            The same sonic architecture â€" structured emotional builds, acoustic intimacy, 
            cathartic resolution, pattern-dense instrumentation â€" runs through the soundtracks 
        ...
        {view === "media" && (
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, marginTop: 8 }}>
              <div style={{ width: 28, height: 28, borderRadius: 5, background: C.amberDim, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: font.mono, fontSize: 14, color: C.amber }}>ðŸ"º</div>
            ...
            <SoundtrackCard
              title="Scrubs"
              medium="TV Â· 2001â€"2010 Â· Music supervisor: Christa Miller"
              color={C.green}
              ...
              examples={[
                { moment: "Colin Hay â€" the acoustic ghost",
                  track: "\"Overkill,\" \"Waiting for My Real Life to Begin,\" \"Beautiful World\"",
                  desc: "Colin Hay appears physically in the show as a wandering musician, then his songs score the emotional climaxes. The diegetic becomes non-diegetic. The music exists in the world and outside it simultaneously. Acoustic guitar, vulnerable male vocal, lyrics about waiting for things to make sense. For a brain with auditory response control at 82, the simplicity of the arrangement â€" single voice, single instrument â€" keeps the processing cost minimal while the lyrical content carries the emotional weight." },
                { moment: "The Fray â€" \"How to Save a Life\"",
                  track: "S5E20 â€" \"My Lunch\"",
                  desc: "The song scores Dr. Cox losing three patients. Piano-driven, building dynamic, lyrics about helplessness. The song became iconic because the show placed it at the exact moment the tonal whiplash architecture demanded total emotional surrender. Same build-to-resolution structure as melodic bass â€" but acoustic, stripped, intimate." },
                { moment: "The musical placement philosophy",
                  track: "Christa Miller's curation approach",
                  desc: "Scrubs doesn't use music as underscore. It uses it as a parallel narrative â€" the song comments on the scene, contradicts it, or completes the emotional information the dialogue can't carry. For a profile where Expressive communication (v=12) is a documented weakness, the soundtrack does the emotional articulation the characters â€" and the viewer â€" can't verbalize." },
              ]}
              emotionalFunction="Scrubs' soundtrack is an Expressive communication prosthetic. Acoustic intimacy, lyrical emotional precision, and a curation philosophy that uses music to say what the scene can't. For Sensation Avoiding at 50/75, the stripped arrangements keep the sensory cost low. For Internalizing at v=21, the lyrics externalize internal states. The same function as ILLENIUM's vocal features â€" but at acoustic scale."
              listeningProfileLink="Colin Hay's sparse acoustic guitar â†' ILLENIUM vocal tracks (emotional articulation). The Fray's piano builds â†' melodic bass build-drop-resolve. Indie vulnerability â†' the pop-punk emotional register from the 2001â€"05 anchor window."
            />

            <SoundtrackCard
              title="Sons of Anarchy"
              medium="TV Â· 2008â€"2014 Â· Music supervisor: Bob Thiele Jr."
              color={C.amber}
              ...
              examples={[
                { moment: "The montage-as-liturgy structure",
                  ...
                  desc: "Every SOA episode ends with a 2-4 minute music montage that scores the consequences of the episode's events across multiple characters simultaneously. The music isn't background â€" it's the binding agent. Folk-rock or acoustic cover, always with a gravitas that elevates street-level violence into something mythic. The montage structure is the build-drop-resolve of the episode arc." },
                { moment: "Cover songs as thematic commentary",
                  track: "\"Bohemian Rhapsody\" (Forest Rangers), \"To Sir With Love\" (Katey Sagal)",
                  desc: "SOA doesn't use original songs for its biggest moments â€" it uses covers. Known songs recontextualized by the show's world. The recursion is musical: you know this melody, but the arrangement and the context transform it. Same pattern-recognition reward as the comedy callbacks â€" familiar structure, new information." },
                { moment: "The White Buffalo as Jax's shadow voice",
                  track: "\"The Matador,\" \"Come Join the Murder\"",
                  desc: "The White Buffalo's baritone folk-rock scores Jax's internal state when the character can't or won't speak it. Acoustic guitar, deep male vocal, lyrics about inevitability and consequence. The same Expressive communication prosthetic as Scrubs' Colin Hay â€" different genre, identical function." },
              ]}
              emotionalFunction="SOA's soundtrack treats every episode ending as a sacred closing ritual â€" the montage-as-liturgy. Acoustic darkness, folk-rock gravitas, and cover songs that leverage the viewer's existing emotional association with the melody. The sound profile is dense enough to score violence as myth but structured enough to stay in the Sensation Avoiding comfort zone. Nothing sonically chaotic. Everything sonically heavy."
              listeningProfileLink="Folk-rock gravitas â†' the emotional weight register in ILLENIUM's vocal collaborations. Acoustic covers â†' temporal anchoring (known melody, new arrangement, same as rewatching). Montage scoring â†' build-to-resolution as episode-closing ritual."
            />

            <SoundtrackCard
              title="Friday Night Lights"
              medium="TV Â· 2006â€"2011 Â· Score: W.G. Snuffy Walden + Explosions in the Sky"
              color={C.blue}
              ...
              examples={[
                { moment: "Explosions in the Sky â€" the show's emotional infrastructure",
                  track: "\"Your Hand in Mine,\" \"First Breath After Coma\"",
                  desc: "Post-rock: no lyrics, guitar-driven, slow builds to cathartic crescendos. Explosions in the Sky doesn't tell you what to feel â€" it architecturally constructs the feeling through dynamic shape. Quiet â†' building â†' swelling â†' release. The structure is identical to melodic bass minus the electronic production. Same build-drop-resolve, acoustic instrumentation." },
                { moment: "The wordless scoring",
                  track: "Throughout series â€" game sequences, emotional climaxes",
                  desc: "FNL's signature emotional moments are scored almost entirely with instrumental music. No lyrics to decode. No vocal processing load on the mildly impaired auditory channel (IVA: 82). Pure dynamic shape â€" the music provides emotional information through structure alone. Polyphia's instrumental approach, in post-rock form." },
                { moment: "The tremolo guitar as emotional grammar",
                  track: "Series-wide scoring technique",
                  desc: "The delayed, reverb-heavy tremolo guitar that defines the FNL sound creates a sonic texture that fills space without density â€" unlike ILLENIUM's wall of sound, this is open, breathing, spatial. But it still displaces. The reverb fills the auditory field gently rather than overwhelmingly. Sensation Avoiding accommodation at lower intensity." },
              ]}
              emotionalFunction="FNL's soundtrack is the acoustic proof that the ILLENIUM connection isn't about genre â€" it's about structure. Post-rock uses the same build-to-catharsis architecture as melodic bass. No lyrics means no auditory language processing load. The emotional information arrives through dynamic shape alone, which plays directly to the visual-dominant processing profile â€" you feel it structurally, not verbally."
              listeningProfileLink="Explosions in the Sky's build-crescendo-resolve â†' ILLENIUM's build-drop-resolve. Instrumental-only â†' Polyphia's no-vocal approach. Tremolo guitar texture â†' the clean-tone harmonic content in Polyphia. Post-rock patience â†' melodic bass compressed into 4 minutes."
            />

            <SoundtrackCard
              title="The Wire"
              medium="TV Â· 2002â€"2008 Â· Music policy: diegetic only (with one exception per season)"
              color={C.ember}
              sonicDNA={["DIEGETIC ONLY", "SOURCE MUSIC AS WORLD-BUILDING", "TOM WAITS THEME COVERS", "SONIC REALISM", "ABSENCE AS AESTHETIC"]}
              keyArtists={["Tom Waits (theme)", "Various â€" diegetic only", "The Blind Boys of Alabama"]}
              examples={[
                { moment: "The diegetic-only policy",
                  track: "No non-diegetic score in the series",
                  desc: "The Wire uses zero non-diegetic music. Every song exists in the show's world â€" from a car radio, a jukebox, a character's headphones. The absence of a score is itself a sonic architecture. No emotional manipulation through music. The viewer must process emotional information without sonic guidance. This is the anti-Scrubs: the soundtrack refuses to do the Expressive work for you." },
                { moment: "The season-opening Tom Waits covers",
                  track: "\"Way Down in the Hole\" â€" 5 different versions across 5 seasons",
                  desc: "Same song, five different artists, five different arrangements. The Blind Boys of Alabama. Steve Earle. The Neville Brothers. Each cover recontextualizes the same structure for the season's institutional focus. The recursion is the SOA cover principle applied to a single song across the entire series â€" familiar structure, shifting context, pattern recognition across arrangements." },
                { moment: "The one exception per season",
                  track: "Non-diegetic music in each season finale's final montage",
                  desc: "Each season breaks its own rule exactly once â€" a non-diegetic song over the closing montage. After 12 episodes of diegetic-only scoring, the sudden appearance of non-diegetic music hits with the force of Scrubs' tonal whiplash. The absence makes the presence devastating. The rule creates the exception's impact." },
              ]}
              ...
              listeningProfileLink="Diegetic-only â†' the opposite of ILLENIUM's total-field saturation, but serving the same brain differently. The absence forces visual-channel processing (IVA visual: 107-110). Tom Waits covers â†' SOA's cover culture â†' temporal anchoring through familiar melody. Season-finale exception â†' the controlled catharsis at maximum impact because of the restraint that preceded it."
            />

            <SoundtrackCard
              title="Psych"
              medium="TV Â· 2006â€"2014 Â· The sleep show"
              color={C.blue}
              ...
              examples={[
                { moment: "\"I Know You Know\" â€" the theme as regulation anchor",
                  track: "The Friendly Indians",
                  desc: "Bright, major-key, acoustic-driven theme song. The first sound of every episode is a known, pleasant, zero-threat auditory stimulus. For a show used as a sleep aid during detox and still used for insomnia, the theme song is the activation signal for the regulation state. Pavlovian auditory conditioning â€" the melody means safety." },
                { moment: "The scoring as ambient predictability",
                  track: "Throughout series â€" comedic underscore",
                ...
                { moment: "The musical episode â€" maximum known quantity",
                  track: "\"Psych: The Musical\" (S7)",
                  desc: "When Psych does a musical episode, the songs are original but stylistically indistinguishable from the show's normal tone â€" bright, playful, unthreatening. Even at maximum musical ambition, the show stays inside its sonic comfort zone. The musical episode is the show proving it will never break the auditory contract." },
              ]}
              emotionalFunction="Psych's soundtrack is the inverse of The Wire's. Where The Wire withholds music to force raw processing, Psych provides constant, predictable, low-threat sound to minimize processing entirely. This is the auditory regulation function at its purest â€" the show that scores sleep. The sonic profile is the exact opposite of ILLENIUM in every parameter (bright vs. dark, sparse vs. dense, quiet vs. loud) but serves the same operator for the same reason: auditory predictability for an over-aroused brain."
              listeningProfileLink="Psych's predictability â†' ILLENIUM's structural predictability (build-drop-resolve is always the same). Bright acoustic â†' the pop-punk anchor window (same tonal register as Good Charlotte/New Found Glory). Zero-threat scoring â†' Sensation Avoiding accommodation at the lowest-energy end of the spectrum."
            />

            <SoundtrackCard
              title="Community"
              medium="TV Â· 2009â€"2015 Â· Composer: Ludwig GÃ¶ransson"
              color={C.green}
              sonicDNA={["GENRE-SHIFTING SCORE", "PASTICHE PRECISION", "PARODY FIDELITY", "THEME VARIATIONS", "META-MUSICAL AWARENESS"]}
              keyArtists={["Ludwig GÃ¶ransson", "Childish Gambino (Donald Glover)", "Ben Folds (cameo)"]}
              examples={[
                { moment: "Genre-accurate scoring for every themed episode",
                  track: "Western, sci-fi, horror, anime, documentary scores",
                  desc: "When Community does a Western episode, the score is an actual Western score. When it does horror, it's scored like horror. Ludwig GÃ¶ransson composes genre-faithful music for each parody, which means the sonic experience shifts completely between episodes. The recursion isn't in the music itself â€" it's in the viewer's recognition of the genre the music is invoking. Pattern recognition as sound design." },
                { moment: "The main theme variations",
                  track: "\"At Least It Was Here\" by The 88 â€" multiple arrangements",
                  desc: "The theme song appears in different arrangements across the series â€" acoustic, 8-bit, orchestral, a cappella â€" mirroring The Wire's Tom Waits approach but comedically. Same melody, shifting context, the show using its own theme as a recursion device." },
              ]}
              emotionalFunction="Community's soundtrack is the musical equivalent of its genre-recursion comedy â€" it asks the viewer to recognize sonic patterns across domains. The score is never just background; it's always commenting on what genre of show you're currently watching. For the Occipital Alpha creativity profile, this is pattern recognition through the auditory channel â€" despite the mild auditory impairment, genre-recognition is processed more holistically than linguistically."
              listeningProfileLink="Genre pastiche â†' Polyphia's genre-defiant blending. Ludwig GÃ¶ransson â†' went on to score Black Panther and The Mandalorian; Community was the laboratory. Theme variations â†' the Tom Waits / SOA cover principle."
            />

            {/* FILM SECTION */}
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, marginTop: 32 }}>
              <div style={{ width: 28, height: 28, borderRadius: 5, background: C.crimsonDim, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: font.mono, fontSize: 14, color: C.crimson }}>ðŸŽ¬</div>
            ...
            <SoundtrackCard
              ...
              medium="Film franchise Â· 2001â€"present"
              color={C.crimson}
              ...
              examples={[
                { moment: "The street-racing sonic palette",
                  ...
                  desc: "Bass-heavy, high BPM, hip-hop-EDM hybrid. The racing sequences are scored like ILLENIUM shows â€" driving rhythm, building energy, physical sonic impact. The franchise's musical DNA is the same activation-energy architecture as the listening profile, but through a hip-hop lens rather than melodic bass." },
                { moment: "\"See You Again\" â€" the franchise's emotional peak",
                  track: "Wiz Khalifa & Charlie Puth Â· Furious 7",
                  desc: "Piano-driven, vocal-led, building to a chorus that resolves into loss acceptance. Paul Walker's tribute. The franchise that's 'ridiculous on purpose' deploys its most emotionally sincere moment through a song structure identical to ILLENIUM's vocal ballads â€" piano build, emotional vocal, harmonic resolution. The absurdity permission structure drops for one song, and the sonic architecture carries the sincerity." },
                { moment: "T.I. as franchise sonic thread",
                  ...
                  desc: "T.I. is in the Apple Music Replay top 20 â€" the only hip-hop artist in a profile dominated by EDM and math rock. T.I. is also in the Fast and Furious franchise. The listening profile and the media preference share an actual artist. The thread is literal." },
              ]}
              emotionalFunction="F&F's soundtrack is the activation-energy function expressed through hip-hop and EDM â€" high BPM, bass-driven, physically stimulating. The racing sequences are scored to provide the same external drive that ILLENIUM provides at 140-174 BPM. And when the franchise needs to land emotional sincerity, it uses the exact same piano-vocal-build structure as the listening profile's catharsis architecture."
              listeningProfileLink="T.I. appears in both the franchise and the Apple Music top 20 â€" the only artist in the media diet who crosses from soundtrack to listening profile. Bass-heavy racing score â†' ILLENIUM's BPM activation. \"See You Again\" piano build â†' ILLENIUM vocal ballad structure."
            />

            <SoundtrackCard
              title="Lord of the Rings"
              medium="Film trilogy Â· 2001â€"2003 Â· Composer: Howard Shore"
              color={C.amber}
              sonicDNA={["LEITMOTIF ARCHITECTURE", "ORCHESTRAL BUILDS", "THEMATIC RECURSION", "CHORAL GRAVITAS", "FELLOWSHIP THEME"]}
              keyArtists={["Howard Shore", "Enya", "Annie Lennox", "RenÃ©e Fleming"]}
              examples={[
                { moment: "The leitmotif system",
                  track: "80+ identified themes across the trilogy",
                  desc: "Howard Shore's score assigns musical themes to characters, places, cultures, and concepts â€" the Shire theme, the Fellowship theme, the Ring theme, Rohan's theme. Each theme is introduced, developed, inverted, and layered across three films. This is the most sophisticated callback architecture in the media diet. The music is a star schema â€" dimensional themes joining on narrative keys." },
                { moment: "The Fellowship theme â€" loyalty as melody",
                  track: "First heard in Rivendell, recurs across trilogy",
                  desc: "The Fellowship theme plays when the group is united and disappears when it fractures. Its return signals reunion. The melody is a loyalty barometer. For a profile where Socialization is the strongest domain, the Fellowship theme is the sonic representation of the media diet's core value â€" chosen family, measured in music." },
                { moment: "Into the West â€" the trilogy's harmonic resolution",
                  track: "Annie Lennox Â· Return of the King",
                  desc: "The trilogy's closing song is a gentle, Celtic-inflected ballad about departure and acceptance. After 9+ hours of orchestral escalation, the resolution is acoustic, intimate, quiet. Same principle as Scrubs â€" the dynamic range matters. The catharsis lands because the restraint follows the intensity." },
              ]}
              emotionalFunction="LOTR's score is the most structurally complex sound design in the media diet â€" 80+ leitmotifs functioning as a cross-referenced musical database. For the Occipital Alpha brain that connects dots and recognizes patterns, Shore's score is an auditory puzzle that rewards attention across 12 hours of film. The leitmotif system is dimensional modeling expressed as orchestration."
              listeningProfileLink="Leitmotif recursion â†' Arrested Development's long-arc callbacks, expressed musically. Orchestral builds â†' post-rock builds (Explosions in the Sky) â†' melodic bass builds (ILLENIUM). Fellowship theme â†' the chosen-family sonic signature. Into the West's acoustic resolution â†' Scrubs' Colin Hay, SOA's White Buffalo."
            />

            {/* GAMES SECTION */}
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, marginTop: 32 }}>
              <div style={{ width: 28, height: 28, borderRadius: 5, background: C.violetDim, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: font.mono, fontSize: 14, color: C.violet }}>ðŸŽ®</div>
            ...
            <SoundtrackCard
              ...
              medium="Game Â· 1997 / 2020 Remake Â· Composer: Nobuo Uematsu"
              color={C.violet}
              ...
              examples={[
                { moment: "Aerith's Theme â€" the franchise's emotional anchor",
                  track: "Plays during the most iconic scene in RPG history",
                  desc: "A simple, descending melody that begins gentle and builds across its runtime. Introduced early, recurring throughout, culminating at the narrative's most devastating moment. The theme is a leitmotif that carries more emotional weight with each recurrence â€" the same callback-as-emotional-accumulation architecture as Arrested Development, but the payoff is grief instead of comedy." },
                { moment: "One-Winged Angel â€" boss battle as catharsis",
                  track: "Sephiroth's theme Â· Final boss",
                  desc: "Latin choral, orchestral, building to frenzy. The most intense musical moment in the game is also the most structured â€" the choir, the orchestra, the relentless driving rhythm all build to a climax that functions identically to ILLENIUM's drops. Maximum sonic density, maximum emotional intensity, guaranteed resolution when the boss falls." },
                { moment: "The Remake's expanded score",
                  track: "Hamauzu's orchestral expansions of Uematsu's themes",
                  desc: "The Remake takes every theme from 1997 and gives it full orchestral treatment. The same melodies, expanded into new arrangements. The recursion spans 23 years â€" the same temporal anchoring as the pop-punk window. You know these melodies from childhood. The Remake recontextualizes them in HD. Known structure, new resolution." },
              ]}
              emotionalFunction="FFVII's score is the oldest sonic anchor in the media diet â€" melodies from age 11 that still carry emotional weight at 38. The leitmotif system parallels LOTR's. The boss battle builds parallel ILLENIUM's. Aerith's theme parallels Scrubs' emotional ambush. 'Inject into my veins' isn't hyperbole â€" this is the longest-running auditory regulation relationship in the entire profile."
              listeningProfileLink="Aerith's Theme â†' the emotional resolution guarantee (ILLENIUM's harmonic resolution, SOA's montage liturgy). One-Winged Angel â†' ILLENIUM's maximum-density catharsis. Remake arrangements â†' the same temporal anchoring as pop-punk: known melody from the formative window, recontextualized."
            />

            <SoundtrackCard
              title="Skyrim / Red Dead / Witcher III"
              medium="Games Â· Open-world RPGs"
              color={C.green}
              sonicDNA={["AMBIENT EXPLORATION", "DYNAMIC SCORING", "ENVIRONMENTAL SOUNDSCAPE", "COMBAT ESCALATION", "WORLD-BUILDING THROUGH SOUND"]}
              keyArtists={["Jeremy Soule (Skyrim)", "Woody Jackson (RDR2)", "Marcin PrzybyÅ‚ek / Mikolai Stroinski (Witcher)"]}
              examples={[
                { moment: "Ambient exploration scoring",
                  track: "Skyrim's exploration themes, RDR2's riding music, Witcher's Kaer Morhen",
                  desc: "Open-world RPGs use ambient scoring that shifts dynamically with the player's context â€" quiet during exploration, escalating during combat, resolving after threat passes. The player controls the emotional pacing by controlling movement. The music responds to behavior. For a profile where Sensation Avoiding is extreme, player-controlled scoring means the auditory environment is self-regulated in real time." },
                { moment: "RDR2's adaptive dynamic range",
                  track: "Riding across the map at sunset",
                  desc: "Red Dead 2's score is the most dynamic in the set â€" it can be nearly silent for minutes, then layer in guitar, then add strings as the landscape shifts. The scoring breathes with the environment. This is the FNL post-rock approach applied to an interactive medium â€" the player's pace determines the build." },
                { moment: "The Witcher's folk-combat contrast",
                  track: "Slavic folk â†' combat metal transitions",
                  desc: "Witcher III shifts from Slavic folk instrumentals during exploration to aggressive, percussion-driven combat scoring. The contrast is Scrubs' tonal whiplash applied to gameplay â€" the dynamic range between states is the emotional architecture." },
              ]}
              emotionalFunction="Open-world RPG scoring is the only category where the listener controls the music's intensity through their own behavior. For a profile built on externalized systems and controlled environments, this is the ultimate auditory regulation architecture â€" the soundtrack responds to the operator's decisions in real time."
              listeningProfileLink="Ambient exploration â†' the low-end of the Sensation Avoiding accommodation spectrum (Psych's predictability). Combat escalation â†' ILLENIUM's builds. Player-controlled pacing â†' the self-curated playlist architecture from the Apple Music data. The operator builds the sonic environment in real time."
            />
          </div>
        )}
        ...
        {view === "function" && (
          <div>
            {[
              {
                fn: "Build â†' Resolve (Catharsis Architecture)",
                color: C.crimson,
                measurement: "Bipolar II Â· Internalizing v=21 Â· Sensation Avoiding 50/75",
                media: [
              ...
              },
              {
                ...
                desc: "Across the diet, the most emotionally loaded moments are scored with the simplest arrangements â€" one voice, one instrument, direct lyrics. This is the Expressive communication prosthetic: music that articulates what the documented weakness (v=12, â‰¤10% base rate) makes harder to say. The low arrangement complexity also keeps the auditory processing cost minimal (IVA auditory: 82).",
              },
              {
                fn: "Sonic Density (Sensory Displacement)",
                color: C.violet,
                measurement: "Sensation Avoiding 50/75 Â· Over-aroused brain Â· Excessive High Beta",
                media: [
              ...
              },
              {
                ...
                color: C.blue,
                measurement: "Sensation Avoiding 50/75 Â· Brown EF Focus T=74 Â· qEEG over-arousal",
                media: [
                  { title: "Psych", role: "Zero-threat, bright, never surprising" },
                  { title: "Open-world ambient", role: "Player-controlled pacing, gentle" },
                  { title: "Pop-punk catalog", role: "Known melodies from 2001â€"05" },
              ...
              },
              {
                ...
                color: C.ember,
                measurement: "Elevated Occipital Alpha Â· Creativity through pattern recognition",
                media: [
              ...
              },
              {
                ...
                desc: "The Conventional profile also appreciates media where sound design follows a rule. The Wire's diegetic-only policy is a governance standard applied to scoring. Seinfeld's bass riff is structural punctuation, not emotion. The absence of a traditional score is itself a system decision â€" and the operator who builds governance systems recognizes governance in sound design.",
              },
            ].map(cat => (
        ...
        <div style={{
          ...
          <div style={{ fontFamily: font.body, fontSize: 15, color: C.creamHigh, lineHeight: 1.8 }}>
            <p style={{ margin: "0 0 14px 0" }}>
              ...
              The same six functions â€" catharsis architecture, expressive prosthetic, sensory displacement, 
              regulation, pattern feeding, and governance-as-absence â€" appear in the soundtrack 
        ...
        <div style={{ marginTop: 48 }}>
          ...
          <div style={{ fontFamily: font.mono, fontSize: 10, color: C.creamDim, letterSpacing: "0.08em", textAlign: "center" }}>
            Dropdown Logistics Â· CONSOLE Â· The Sonic Thread Â· 6 functions Â· 10 soundtracks Â· 1 listening profile
          </div>
        </div>
      </div>
    </div>
